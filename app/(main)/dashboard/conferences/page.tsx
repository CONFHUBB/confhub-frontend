                        ...
                        <div className="flex gap-1.5 flex-wrap mt-2">
                            {STATUS_OPTIONS.map(s => (
                                <button
                                    ...
                                    className={`text-xs px-3 py-1 rounded-full font-medium transition-colors whitespace-nowrap ${activeFilter === s
                                                        ...
                                                        <div className="flex items-center justify-end gap-1.5 flex-nowrap whitespace-nowrap">
                                                            ...
                                                            {c.status === "PENDING_APPROVAL" && (
                                                                <>
                                                                    <Button
                                                                        size="sm"
                                                                        className="h-7 text-xs min-w-[64px] px-2 whitespace-nowrap bg-emerald-600 hover:bg-emerald-700 gap-1"
                                                                    ...
                                                                    <Button
                                                                        size="sm"
                                                                        variant="outline"
                                                                        className="h-7 text-xs min-w-[64px] px-2 whitespace-nowrap text-rose-600 border-rose-200 hover:bg-rose-50 gap-1"
                                                            ...
                                                            <Button variant="outline" size="sm" className="h-7 text-xs min-w-[64px] px-2" asChild>
