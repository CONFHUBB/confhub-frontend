        ...
        <Card className="border-none shadow-none bg-transparent">
            ...
            <div className="flex gap-1 border-b mb-6 mt-2">
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${activeTab === 'config'
                ...
                <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 text-sm font-medium border-b-2 -mb-px transition-colors ${activeTab === 'log'
                        ? 'border-primary text-primary'
                        : 'border-transparent text-muted-foreground hover:text-foreground hover:border-gray-300'
                        }`}
                >
                            ...
                            {activities.length === 0 ? (
                                ...
                                activities.map((activity, index) => {
                                    ...
                                    return (
                                        <div
                                            key={activity.id}
                                            className={`flex flex-row items-center p-4 gap-3 transition-colors ${isCurrent
                                        ...
                                        >
                                            {/* Left column: icon + info + quick action + warnings */}
                                                ...
                                                <div className="sm:w-63 relative">
                                                    <div className="relative">
                                                        <Input
                                                            ...
                                                            className={`text-sm cursor-pointer w-full text-foreground/90 pl-8 ${validationErrors[activity.activityType]
                                                    ...
                                                    {validationErrors[activity.activityType] && (
                                                        <p className="absolute top-full left-0 mt-1 text-[11px] text-red-600 font-medium flex items-start gap-1 whitespace-nowrap">
