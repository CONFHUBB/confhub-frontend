        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    ...
                    <p className="mt-1 text-sm text-muted-foreground">
                        Manage conferences where you serve as Chair or Program Chair
                    </p>
                </div>
            ...
            {conferences.length === 0 ? (
                <div className="rounded-xl border-2 border-dashed border-gray-200 bg-gray-50/50 py-16 text-center">
                    ...
                    <p className="text-sm text-muted-foreground mt-1 mb-6">You are not chairing any conferences. Create one to get started.</p>
                    <Link href="/conference/create">
